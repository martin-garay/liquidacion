...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, punto_montaje, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'16', --punto_montaje
	'dt_periodos_detalle', --subclase
	'clases/datos_tabla/dt_periodos_detalle.php', --subclase_archivo
	NULL, --objeto_categoria_proyecto
	NULL, --objeto_categoria
	'DT - periodos_detalle', --nombre
	NULL, --titulo
	NULL, --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa, tabla) VALUES (
	...
	'E', --tipo
	'1', --pk
	'periodos_detalle_id_seq', --secuencia
	NULL, --largo
	NULL, --no_nulo
	'1', --no_nulo_db
	'0', --externa
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa, tabla) VALUES (
	...
	'2891', --objeto
	'1565', --col_id
	'inasistencias_justificadas', --columna
	'N', --tipo
	'0', --pk
	'', --secuencia
	NULL, --largo
...
INSERT INTO apex_objeto_db_registros_col (objeto_proyecto, objeto, col_id, columna, tipo, pk, secuencia, largo, no_nulo, no_nulo_db, externa, tabla) VALUES (
	...
	'2891', --objeto
	'1566', --col_id
	'inasistencias_injustificadas', --columna
	'N', --tipo
	'0', --pk
	'', --secuencia
	NULL, --largo
