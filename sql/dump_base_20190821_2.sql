...
--
-- Name: tabla_vacaciones_dias_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tabla_vacaciones_dias_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: tabla_vacaciones_dias_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tabla_vacaciones_dias_id_seq OWNED BY public.tabla_vacaciones_dias.id;


--
-- Name: tabla_vacaciones_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tabla_vacaciones_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: tabla_vacaciones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tabla_vacaciones_id_seq OWNED BY public.tabla_vacaciones.id;
...
--
-- Name: fichajes_resumen id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: tabla_vacaciones id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tabla_vacaciones ALTER COLUMN id SET DEFAULT nextval('public.tabla_vacaciones_id_seq'::regclass);


--
-- Name: tabla_vacaciones_dias id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tabla_vacaciones_dias ALTER COLUMN id SET DEFAULT nextval('public.tabla_vacaciones_dias_id_seq'::regclass);
...
INSERT INTO public.conceptos VALUES (1, 'Sueldo Básico', '1', 1, 'basico', true, true, true, NULL, NULL);
INSERT INTO public.conceptos VALUES (4, 'Idem Sueldo Basico', '90', 1, 'c1', false, false, false, 'Ver si se utiliza el concepto nro 1 directamente', NULL);
...
En el sistema anterior es el concepto #700 pero aca hay que calcularlo antes de calcular la antiguedad que es el concepto #102', NULL);
INSERT INTO public.conceptos VALUES (7, 'Horas Extras', '3', 1, '( c1 / 200 ) * 1.5 *  hsextras', true, true, false, NULL, NULL);
INSERT INTO public.conceptos VALUES (8, 'Jubilacion', '500', 2, 'bruto * 0.11', true, true, false, NULL, NULL);
INSERT INTO public.conceptos VALUES (9, 'INNSJP-LEY 1903', '501', 2, 'bruto * 0.03', true, true, false, NULL, NULL);
INSERT INTO public.conceptos VALUES (10, 'Obra Social', '502', 2, 'bruto * 0.03', true, true, false, NULL, NULL);
INSERT INTO public.conceptos VALUES (11, 'Cuota solidaria Utedyc', '511', 2, 'bruto * 0.25', true, true, false, NULL, NULL);
...
SELECT pg_catalog.setval('public.tabla_ganancias_id_seq', 1, false);


--
-- Name: tabla_vacaciones_dias_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.tabla_vacaciones_dias_id_seq', 5, true);


--
-- Name: tabla_vacaciones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.tabla_vacaciones_id_seq', 4, true);
...
--
-- Name: fichajes_resumen pk_fichajes_resumen; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fichajes_resumen fk_fichajes_resumen__personas; Type: FK CONSTRAINT; Schema: public; Owner: -
--
